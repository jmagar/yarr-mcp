...
This is a **skills-only, no-MCP** plugin. The skill drives the Bazarr REST API
...
hook writes them to `~/.config/lab-bazarr/config.json`, which the skill scripts load
