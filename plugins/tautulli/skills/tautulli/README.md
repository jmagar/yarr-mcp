...
|---------|-----------|----------------|
| **Current Sessions** | yes Real-time | yes Real-time + bandwidth |
| **Search Media** | yes All libraries | no (use Plex) |
| **Library Browse** | yes Full browse | yes Stats only |
| **Watch History** | no | yes Detailed history |
| **User Statistics** | no | yes Complete analytics |
| **Popular Content** | no | yes Trending analysis |
| **Stream Analytics** | no | yes Transcode stats |
| **Temporal Trends** | no | yes Time-based patterns |
