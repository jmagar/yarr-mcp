---
name: tautulli
description: This skill should be used when the user asks about Plex watch statistics, historical playback data, most-watched content, user activity trends, library stats, stream analytics, or anything related to Tautulli monitoring and analytics — favor this over the `plex` skill for historical/aggregate analysis; use `plex` for live server state (libraries, search, current session details). Triggers include current streams, who is watching Plex, and active sessions too, since Tautulli also tracks those.
---
