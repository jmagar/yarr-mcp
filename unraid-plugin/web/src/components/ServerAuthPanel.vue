...
<template>
  <section class="yarr-panel" aria-labelledby="server-heading">
    ...
    <div class="yarr-form-rows">
      ...
      <label class="yarr-setting-row"><span><strong>Dashboard widget</strong><small>Show compact Yarr runtime status on the Unraid dashboard.</small></span><input type="checkbox" :checked="plugin.dashboardWidgetEnable" :disabled="disabled" @change="patchPlugin({ dashboardWidgetEnable: ($event.target as HTMLInputElement).checked })"></label>
